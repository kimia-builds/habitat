...
// RENDERED ONCE FOR THE WHOLE FILE (2026-08-19). The dressed flora put about
// 41,000 SVG paths on this page, and building that a dozen times over — once
// per test — timed the suite out. Every assertion below is a read, so they can
// all read the same render; the one test that clicks does so last.
const onBack = vi.fn()
let container

beforeAll(() => {
  container = render(<DesignPage onBack={onBack} />).container
})
